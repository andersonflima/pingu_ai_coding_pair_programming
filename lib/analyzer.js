...
const { checkMissingAwait } = require('./analyzer-async');
...
const { snippetFunctionDoc, snippetFunctionComment, snippetFunctionSpec, sanitizeAnalysisLine, sanitizeIdentifier, countBlockDelta, countMatches, isReservedToken, escapeRegExp, buildMaintenanceComment, isDependencyDeclarationLine, isCommentLine, lineIndentation, stripInlineComment, humanizeIdentifier, splitTopLevelParams, leadingIndentLength } = require('./support');
const { stripPythonInlineSyntax, extractPythonImportVars } = require('./python-scope-utils');
