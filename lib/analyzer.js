...
const { readElixirFunctionDeclaration, parseFunctionDeclaration, extractBoundPatternVars } = require('./function-signature');
...
} = require('./analyzer-undefined-correction');
...
} = require('./analyzer-import-bindings');
const {
...
const { snippetFunctionDoc, snippetFunctionComment, snippetFunctionSpec, sanitizeAnalysisLine, sanitizeIdentifier, countBlockDelta, countMatches, isReservedToken, buildMaintenanceComment, isDependencyDeclarationLine, isCommentLine, lineIndentation, stripInlineComment, humanizeIdentifier, leadingIndentLength, isJavaScriptControlKeyword } = require('./support');
const { stripPythonInlineSyntax, extractPythonImportVars, sanitizeScopedAnalysisLine, stripPythonMultilineStringContent } = require('./python-scope-utils');
