...
const LANGUAGE_CAPABILITY_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    commentTaskIntents: ['comment', 'function'],
    offlineCapabilities: ['document_generation', 'terminal_task'],
    bestPractices: [
      'Prefira metodos pequenos e coesos com nomes que revelem intencao.',
      'Documente o contrato publico com Javadoc objetivo (o que faz, parametros, retorno).',
      'Evite estado mutavel compartilhado; isole efeitos colaterais.',
      'Trate erros com excecoes especificas e mensagens claras.',
    ],
  },
  {
    id: 'csharp',
    ...
    offlineCapabilities: ['document_generation', 'terminal_task'],
    bestPractices: [
      'Use XML doc comments (///) para descrever o contrato publico.',
      'Prefira metodos coesos e nomes orientados a intencao de dominio.',
      'Isole efeitos colaterais e prefira imutabilidade quando possivel.',
      'Trate erros com excecoes especificas e mensagens claras.',
    ],
  },
  {
    ...
    offlineCapabilities: ['document_generation', 'terminal_task'],
    bestPractices: [
      'Prefira funcoes puras e val sobre var para reduzir estado mutavel.',
      'Documente o contrato publico com KDoc objetivo.',
      'Aproveite null-safety e tipos para tornar contratos explicitos.',
      'Isole efeitos colaterais em fronteiras claras.',
    ],
  },
  {
    id: 'swift',
    ...
    offlineCapabilities: ['document_generation', 'terminal_task'],
    bestPractices: [
      'Documente o contrato publico com comentarios /// objetivos.',
      'Prefira let sobre var e tipos de valor para reduzir estado mutavel.',
      'Use optionals de forma explicita para expressar ausencia.',
      'Isole efeitos colaterais e mantenha funcoes pequenas.',
    ],
  },
  {
    id: 'scala',
    ...
    offlineCapabilities: ['document_generation', 'terminal_task'],
    bestPractices: [
      'Prefira imutabilidade, funcoes puras e composicao.',
      'Documente o contrato publico com Scaladoc objetivo.',
      'Modele ausencia e erro com Option/Either em vez de excecoes implicitas.',
      'Mantenha efeitos colaterais isolados nas fronteiras.',
    ],
  },
  {
    id: 'php',
    ...
    offlineCapabilities: ['document_generation', 'terminal_task'],
    bestPractices: [
      'Documente o contrato publico com PHPDoc (resumo, @param, @return).',
      'Prefira funcoes pequenas com tipos declarados quando possivel.',
      'Isole efeitos colaterais e valide entradas nas fronteiras.',
      'Trate erros com excecoes especificas e mensagens claras.',
    ],
  },
  {
    ...
    unitTestStyle: 'none',
    structured: true,
    editorFeatures: ['comment_task', 'context_file', 'terminal_task'],
    commentTaskIntents: ['config', 'required_version', 'context_blueprint'],
    offlineCapabilities: ['required_version_fix', 'context_blueprint', 'terminal_task'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['comment_task', 'context_blueprint', 'terminal_task'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['document_generation', 'context_blueprint', 'terminal_task'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['diagram_generation', 'context_blueprint', 'terminal_task'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['workdir_generation', 'context_blueprint', 'terminal_task'],
    bestPractices: [
