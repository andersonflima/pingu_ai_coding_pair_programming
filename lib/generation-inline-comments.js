...
const VERB_TRANSLATIONS = Object.freeze({
  ...
  // Mais verbos em ingles.
  select: 'Seleciona', pick: 'Escolhe', choose: 'Escolhe', assign: 'Atribui',
  bind: 'Vincula', attach: 'Anexa', link: 'Vincula', wrap: 'Envolve', unwrap: 'Extrai',
  extract: 'Extrai', collect: 'Coleta', gather: 'Reune', aggregate: 'Agrega',
  group: 'Agrupa', split: 'Divide', slice: 'Fatia', chunk: 'Divide', flatten: 'Achata',
  reduce: 'Reduz', accumulate: 'Acumula', increment: 'Incrementa', decrement: 'Decrementa',
  multiply: 'Multiplica', divide: 'Divide', subtract: 'Subtrai', compare: 'Compara',
  contains: 'Verifica se contem', includes: 'Verifica se contem', exists: 'Verifica se existe',
  require: 'Exige', assert: 'Garante', retry: 'Repete', schedule: 'Agenda',
  queue: 'Enfileira', enqueue: 'Enfileira', dequeue: 'Desenfileira', subscribe: 'Inscreve',
  unsubscribe: 'Desinscreve', listen: 'Escuta', watch: 'Observa', observe: 'Observa',
  track: 'Rastreia', monitor: 'Monitora', measure: 'Mede', record: 'Registra',
  cache: 'Armazena em cache', poll: 'Consulta', request: 'Solicita', respond: 'Responde',
  reply: 'Responde', route: 'Roteia', redirect: 'Redireciona', forward: 'Encaminha',
  mount: 'Monta', setup: 'Configura', configure: 'Configura', release: 'Libera',
  acquire: 'Adquire', lock: 'Bloqueia', unlock: 'Desbloqueia', grant: 'Concede',
  revoke: 'Revoga', authorize: 'Autoriza', authenticate: 'Autentica', login: 'Autentica',
  logout: 'Encerra a sessao', sign: 'Assina', hash: 'Gera hash de', encrypt: 'Criptografa',
  decrypt: 'Descriptografa', compress: 'Comprime', decompress: 'Descomprime',
  upload: 'Envia', download: 'Baixa', import: 'Importa', export: 'Exporta', sync: 'Sincroniza',
  migrate: 'Migra', seed: 'Popula', populate: 'Popula', fill: 'Preenche', paginate: 'Pagina',
  truncate: 'Trunca', round: 'Arredonda', clamp: 'Limita', resize: 'Redimensiona',
  translate: 'Traduz', escape: 'Escapa', trim: 'Apara', capitalize: 'Capitaliza',
  tokenize: 'Tokeniza', compile: 'Compila', evaluate: 'Avalia', infer: 'Infere',
  predict: 'Preve', classify: 'Classifica', detect: 'Detecta', analyze: 'Analisa',
  inspect: 'Inspeciona', list: 'Lista', describe: 'Descreve', summarize: 'Resume',
  // Verbos ja em portugues.
  seleciona: 'Seleciona', selecionar: 'Seleciona', adiciona: 'Adiciona', adicionar: 'Adiciona',
  insere: 'Insere', inserir: 'Insere', define: 'Define', definir: 'Define', verifica: 'Verifica',
  verificar: 'Verifica', lista: 'Lista', listar: 'Lista', ordena: 'Ordena', ordenar: 'Ordena',
  filtra: 'Filtra', filtrar: 'Filtra', mapeia: 'Mapeia', mapear: 'Mapeia', agrupa: 'Agrupa',
  agrupar: 'Agrupa', compara: 'Compara', comparar: 'Compara', monta: 'Monta', montar: 'Monta',
  configura: 'Configura', configurar: 'Configura', inicia: 'Inicia', iniciar: 'Inicia',
  encerra: 'Encerra', encerrar: 'Encerra', abre: 'Abre', abrir: 'Abre', fecha: 'Fecha',
  fechar: 'Fecha', conecta: 'Conecta', conectar: 'Conecta', registra: 'Registra',
  registrar: 'Registra', notifica: 'Notifica', notificar: 'Notifica', importa: 'Importa',
  importar: 'Importa', exporta: 'Exporta', exportar: 'Exporta', sincroniza: 'Sincroniza',
  sincronizar: 'Sincroniza', imprime: 'Imprime', imprimir: 'Imprime', le: 'Le', ler: 'Le',
  apaga: 'Remove', apagar: 'Remove', exclui: 'Remove', excluir: 'Remove', aplica: 'Aplica',
  aplicar: 'Aplica', executa: 'Executa', executar: 'Executa', trata: 'Trata', tratar: 'Trata',
  // Verbos ja em portugues (lote original).
  ...
  atualiza: 'Atualiza', atualizar: 'Atualiza', remover: 'Remove',
