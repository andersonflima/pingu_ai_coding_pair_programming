...
function buildPromptTaskRequest(payload = {}) {
  ...
  return {
    mode: 'prompt_task',
    file,
    projectRoot: path.resolve(String(payload.projectRoot || payload.root || path.dirname(file))),
    ...
    constraints: [
      'Use o arquivo em file, selectedText e lines como contexto primario da resposta.',
      'So considere outros arquivos quando o prompt citar explicitamente outro caminho, modulo ou contexto de diretorio.',
