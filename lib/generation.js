...
const offlineCommentTaskAiTools = Object.freeze({
  // Entrada: contexto do runtime | Saida: false para disponibilidade de IA externa.
  hasOpenAiConfiguration: () => false,
  // Entrada: payload de geração | Saida: sem resposta de IA (modo offline).
  resolveAiContextResolution: () => null,
  // Entrada: request de tarefa | Saida: sem retorno de IA (modo offline).
  resolveAiGeneratedTask: () => null,
  // Entrada: request de testes | Saida: sem retorno de IA (modo offline).
  resolveAiGeneratedUnitTests: () => null,
  // Entrada: request de correção | Saida: sem retorno de IA (modo offline).
