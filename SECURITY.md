...
O prompt manual `:PinguPrompt <texto>` pode reescrever o range selecionado no buffer via provider assistido, mas nao executa comandos de terminal diretamente. `:PinguPrompt` sem argumento abre um terminal interativo do editor; comandos digitados nessa sessao seguem sob controle manual do usuario.
